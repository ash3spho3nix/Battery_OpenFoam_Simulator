...
This module provides the UILoader class for loading .ui files at runtime.
"""
...
class UILoader:
    ...
    def load_ui_file(ui_file_path: str, parent: Optional[QWidget] = None) -> QWidget:
        """
        Load a .ui file using PyQt6's uic.loadUi() function.
    ...
    @staticmethod
    def get_available_ui_files(base_path: Optional[str] = None) -> List[str]:
        """
        ...
        ui_files = []
        for ui_file in base_path.glob("*.ui"):
            ui_files.append(ui_file.stem)
...
# Import UIConfig from the same file for backward compatibility
