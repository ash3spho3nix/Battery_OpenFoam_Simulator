...
class TestMainWindow:
    ...
    def test_project_creation_success(self, mock_project_manager):
    ...
    @patch('src.gui.main_window.ProjectManager')
    def test_project_creation_failure(self, mock_project_manager):
    ...
    def test_name_hint_dialog(self):
    ...
    def test_recent_project_opening(self):
    ...
    @patch('src.gui.main_window.ProjectManager')
    def test_existing_project_opening(self, mock_project_manager):
...
def test_main_window_comprehensive():
    """Comprehensive test for MainWindow functionality."""
...
if __name__ == "__main__":
    ...
    test_main_window_comprehensive()
    print("MainWindow unit tests completed successfully")